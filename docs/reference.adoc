...
[NOTE]
====
KVO publisher access implies that with MacOS 10.15 release, most of appkit UI elements will be accessible as publishers. UIKit controls, however, aren't KVO compatible.
====
