...
If you want a publisher that provides a single value, then look at <<#reference-just>> or <<#reference-deferred>> publishers as alternatives.
...
__icon:apple[] docs__:: https://developer.apple.com/documentation/combine/observableobjectpublisher[`ObservableObjectPublisher`]
...
__icon:apple[] docs__:: https://developer.apple.com/documentation/foundation/notificationcenter/[`NotificationCenter`]

__Usage__::

* <<patterns.adoc#patterns-notificationcenter>>
...
__icon:apple[] docs__:: https://developer.apple.com/documentation/foundation/timer[`Timer`]
...
__icon:apple[] docs__::  https://developer.apple.com/documentation/combine/publishers/breakpoint

__Usage__::

* <<patterns.adoc#patterns-debugging-breakpoint>>
...
__icon:apple[] docs__:: https://developer.apple.com/documentation/combine/publishers/breakpoint/3205192-breakpointonerror
...
* <<patterns.adoc#patterns-debugging-handleevents>>
...
* <<patterns.adoc#patterns-debugging-print>>
...
If you want to influence a previously chained publishers (or operators) for where to run, you may want to look at the <<#reference-subscribe>> operator.
...
It is relatively infrequently used, specifically to encourage a publisher such as <<#reference-just>> or <<#reference-deferred>> to run on a specific queue.
If you want to control which queue operators run on, then it is more common to use the <<#reference-receive>> operator, which effects all following operators and subscribers.
...
Some publishers (such as <<#reference-datataskpublisher>>) have complex internals that will run on alterantive queues based on their configuration, and will be relatively uneffected by subscribe.
...
The solution is to either use <<#reference-sink>>, or to include a map operator prior to assignment that changes the output type to match.
