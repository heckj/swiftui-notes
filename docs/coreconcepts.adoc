...
To illustrate how these diagrams relate to code, let's look at this simple example.
...
This one is more complex to make it easier to understand how the diagrams can be interpretted and how they relate to any Combine code you create.
====
