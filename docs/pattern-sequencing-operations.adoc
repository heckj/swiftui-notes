...
[TIP]
====
This is similiar to a concept called "promise chaining".
While you can arrange combine such that it acts similiarly, it is likely not a good replacement for using a promise library.
