...
See <<reference#reference-catch,catch>> for more illustration and examples of how this works.

If you want to continue to respond to errors and handle them, see <<patterns#patterns-continual-error-handling,Using flatMap with catch to handle errors>> for an example of how to do that using <<reference#reference-flatmap,flatMap>>.
