...
If the pipeline is set up to continually update, the error handling needs to be a little more complex, and you should jump ahead to <<patterns-oneshot-error-handling>>.
